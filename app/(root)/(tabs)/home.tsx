...
export default function Home() {
   ...
   useEffect(() => {
      const requestLocationPermission = async () => {
         ...
         if (location?.coords) {
            fetch(
               `https://api.geoapify.com/v1/geocode/reverse?lat=${location.coords.latitude}&lon=${location.coords.longitude}&apiKey=${process.env.EXPO_PUBLIC_GEOAPIFY_API_KEY}`
            )
            ...
            ListHeaderComponent={() => (
               <>
                  <View className='flex flex-row justify-between my-5'>
                     <Text className='text-base font-JakartaExtraBold capitalize'>
